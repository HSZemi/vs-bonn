...
(3) Die Amtszeit der unter §2Abs.2Nr.1 und §2Abs.2Nr.2 aufgeführten Organe beträgt ein Jahr.
...
(2) Die Wahl wird vom Wahlausschuss (§7Abs.1Nr.3) vorbereitet und durchgeführt.
...
(3) Der geschäftsführende Vorstand wird entsprechend §8Abs.5 gewählt.
...
Angeklagte das Recht sich zu verteidigen und es muss eine Diskussionsrunde stattfinden.
...
Nachfolger. Dazu muss gemäß §8Abs.9 eingeladen werden.
...
Der FSR-Sprecher ist verpflichtet Übergabe- und Rücknahme-Protokolle über ausgegebene und
...
Die FSVV, die aus allen wahlberechtigten Mitgliedern der FS VWL besteht, ist ein beschlussfassendes
...
(4) Anschaffung und Ausgaben, die von den unter dem Titel Sonstigem Haushaltsplan
ausgewiesenen Geldern getätigt werden und einen Höchstbetrag von:
...
die Kasse von den Kassenprüfern mindestens einmal jährlich geprüft. Die Kassenprüfung
...
Regelung zu außerordentlichen FSV-Sitzungen ist unanwendbar (§10Abs.6).
...
Die Satzung der FS VWL in der Fassung vom 07.06.2018 tritt mit Inkrafttreten dieser Satzung vom
16.01.2020 außer Kraft.
